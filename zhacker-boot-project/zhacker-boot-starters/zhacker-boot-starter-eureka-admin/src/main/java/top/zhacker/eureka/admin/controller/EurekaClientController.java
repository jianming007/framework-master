package top.zhacker.eureka.admin.controller;
...
import top.zhacker.eureka.admin.http.HttpUtil;
...
//		HttpUtil.post(instanceInfo.getHomePageUrl() + "eureka/apps/"+ appName + "/"+ instanceId +"/status?value="+ status, "");
